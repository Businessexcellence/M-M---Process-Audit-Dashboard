  ...
  return c.html(`
    ...
    <body class="bg-gray-50">
        ...
        <main class="px-6 py-6">
            ...
            <!-- Overview Tab -->
            <div id="tab-overview" class="tab-content page-transition">
                ...
                <!-- Data Insights & Analysis Dashboard - Will be populated dynamically after data upload -->
                <div id="insights-section" class="dashboard-card p-6 mb-6 bg-gradient-to-br from-purple-50 via-pink-50 to-red-50" style="display: none;">
                    <h3 class="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
                        <i class="fas fa-brain text-purple-600"></i>
                        AI-Powered Data Insights
                    </h3>
                    <div id="insights-cards-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <!-- Will be populated dynamically -->
                    </div>
                </div>
                
                <!-- Actionable Recommendations - Will be populated dynamically after data upload -->
                <div id="recommendations-section" class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6" style="display: none;">
